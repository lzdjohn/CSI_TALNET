...
class PtTransformer(nn.Module):
    ...
    def forward(self, video_list):
        ...
        if self.training:
            ...
            # list of prediction targets(真实值) gt_cls_labels是one_hot编码
    ...
    def preprocessing(self, video_list, padding_val=0.0):
        ...
        if self.training:
            ...
            batched_inputs = feats[1].new_full(batch_shape, padding_val)
    ...
    def label_points(self, points, gt_segments, gt_labels):
        ...
        for gt_segment, gt_label in zip(gt_segments, gt_labels):
            ...
            # print("gt_segment, gt_label", gt_segment, gt_label)
